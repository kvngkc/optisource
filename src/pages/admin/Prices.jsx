...
export default function Prices() {
  ...
  const allProducts = [...new Map(prices.map(p => [p.product_id, p])).values()]
    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 py-6 lg:px-6 lg:py-10">
        ...
        <p className="text-slate-500 text-sm mb-6">
          Set prices per product. Prices auto-fill in Sales when a matching spec is selected.
        </p>

        {(
          <>
            <div className="bg-white rounded-2xl border border-slate-200 p-5 mb-6">
              <h3 className="font-semibold text-slate-700 mb-1">Set price</h3>
